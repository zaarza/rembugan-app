    ...
    return (
        <div className="flex gap-x-5">
            ...
            <div className="flex flex-col gap-y-2">
                <h1 className="text-sm text-slate-800 font-medium whitespace-nowrap">Samsudin sent you a friend request</h1>
                <h2 className="text-xs text-slate-800">Today at 08:27 AM</h2>
