...
import Menu from "@/components/Elements/Menubar/Button/Inbox/Menu";
...
const MenubarInboxButton = () => {
    ...
    return (
        <div className="relative" ref={menuRef}>
            <ButtonIcon action={() => setShowInbox(!showInbox)} active={showInbox}>
            ...
            <Menu activeInboxCategory={activeInboxCategory} setActiveInboxCategory={setActiveInboxCategory} active={showInbox} toggleActive={() => setShowInbox(!showInbox)} inbox={inbox} />
        </div>
    );
};
