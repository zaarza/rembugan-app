...
import { deleteCurrentUserAvatar } from '@/features/auth/data/api';
        ...
        >
            ...
            >
                <div className='flex flex-col items-center gap-y-1'>
                    ...
                    <h1 className='font-medium text-slate-800'>{user.name}</h1>
                    <small className='text-xs text-slate-500'>@{user.id}</small>
                </div>
