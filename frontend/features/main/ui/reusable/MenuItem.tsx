...
const MenuItem = ({ name, time, message, notificationCount = 0, profilePicturePath, action }: MenuItemProps) => {
    return (
        <button
        ...
        >
            ...
            <div className="flex flex-col items-start gap-y-1 lg:w-[80%] w-full">
                ...
                <div className="flex justify-between w-full items-start">
                    <h2 className="text-sm text-slate-500 line-clamp-1 overflow-clip text-left max-w-[90%]">{message}</h2>
